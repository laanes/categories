	...
	global $glob;
		...
		if($this->data) {
			...
			$output = '<ul id="nav">';
				...
				$output .= '<li><a href="' . $glob['storeURL'] . '/' . $cats[$i]['cat_name'] . '/cat_' . $cats[$i]['cat_id'] . '.html">' . $cats[$i]['cat_name'].'</a>';
					...
					$output .= "<ul>";
						...
						$output .= '<li><a href="' . $glob['storeURL'] . '/' . $cats[$i]['cat_name'] . "/" . $second[$j]['cat_name'] . '/cat_' . $second[$j]['cat_id'] . '.html">' . $second[$j]['cat_name'].'</a>';
						...
						$third = $this->get_categories('cat_father_id = ' . $second[$j]['cat_id']);
							...
							$output .= "<ul>";
								...
								$output .= '<li><a href="' . $glob['storeURL'] . '/' . $cats[$i]['cat_name'] . "/" . $second[$j]['cat_name'] . '/' . $third[$k]['cat_name'] . '/cat_' . $third[$k]['cat_id'] . '.html">' . $third[$k]['cat_name'] . "</a></li>";
